...
import { Plus, Pencil, Trash2, X, GripVertical, Eye, EyeOff, ImagePlus, ImageMinus, Loader2 } from 'lucide-react'
                                    ...
                                    <tr key={service._id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-4">
                                                <div className="relative w-12 h-12 bg-deep-space-blue-50 rounded-xl overflow-hidden">
                                                    {service.images?.[0] && <Image src={service.images[0]} alt={service.title} fill className="object-cover" />}
                                                </div>
                                                <div>
                    ...
                    <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-6 space-y-4">
                            <div>
                                ...
                                <input type="text" value={formData.title} onChange={(e) => setFormData({ ...formData, title: e.target.value })} className="w-full p-3 rounded-xl bg-gray-50 border-2 border-gray-200 focus:border-deep-space-blue-500 focus:outline-none" placeholder="e.g., Construction" />
                            </div>
                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-2">Description</label>
                                <textarea rows={3} value={formData.description} onChange={(e) => setFormData({ ...formData, description: e.target.value })} className="w-full p-3 rounded-xl bg-gray-50 border-2 border-gray-200 focus:border-deep-space-blue-500 focus:outline-none resize-none"></textarea>
                            </div>
                            <div>
